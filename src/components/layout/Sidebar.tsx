  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-60 bg-brand-900 text-white flex flex-col z-40">
      ...
      <div className="px-3 py-4 border-t border-brand-700 space-y-0.5">
        <Link
          href="/settings"
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-brand-300 hover:bg-brand-800 hover:text-white transition-colors"
        >
          <Settings size={18} />
          설정
        </Link>
        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-brand-300 hover:bg-brand-800 hover:text-white transition-colors">
          <LogOut size={18} />
          로그아웃
        </button>
      </div>
